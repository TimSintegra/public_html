...
$formDetails = array('formTitle' => 'Добавить преимущества',
    'submitName' => 'add_news',
...
if (isset($_POST[$formDetails['submitName']]) && $_POST[$formDetails['submitName']]== $formDetails['submitValue'])
{
    ...
    if (!$_FILES['adv']['tmp_name']) {
        $errorText ='Обязательные поля для заполнения: Изображение, Заголовок';
    } else {
