...
<div id="blockpadding">
    <form action="{$ADMIN_URL}/admins/add/" method="post" name="adminform">
        <div class="rowform"><label>Тип администратора:</label>{$roleSelect}</div>
        <div class="rowform"><label>Логин:</label><input type="text" name="admin_username" value="{$_val.admin_username}"></div>
