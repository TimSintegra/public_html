...
function content_68f1e99aea78d8_31290176 (\Smarty\Template $_smarty_tpl) {
...
<div>
    <p><?php echo $_smarty_tpl->getValue('header_way');?>
</p>
</div>
<div>
    <p><?php echo $_smarty_tpl->getValue('header_milestone');?>
</p>
</div>
<div class="timeline">
<?php
                    ...
                    <div class="partner-info-left">
                        <div class="partner-header">
                            <div class="partner-icon">
                                <img src="<?php echo $_smarty_tpl->getValue('TPL_URL');?>
/images/partners/<?php echo $_smarty_tpl->getValue('partner')['icon'];?>
                    ...
                    <?php if ($_smarty_tpl->getValue('partner')['image']) {?>
                        <div class="partner-info-right">
                            <div class="partner-image">
                                <img src="<?php echo $_smarty_tpl->getValue('TPL_URL');?>
/images/partners/<?php echo $_smarty_tpl->getValue('partner')['image'];?>
" alt="<?php echo $_smarty_tpl->getValue('partner')['title'];?>
">
                            </div>
                            <?php if ($_smarty_tpl->getValue('partner')['information_image']) {?>
                                <div class="partner-image-caption">
                                    <p><?php echo $_smarty_tpl->getValue('partner')['information_image'];?>
</p>
                                </div>
                            <?php }?>
                        </div>
...
<div>
    <p><?php echo $_smarty_tpl->getValue('header_result');?>
</p>
</div>
<div>
    <p><?php echo $_smarty_tpl->getValue('header_certificates');?>
</p>
</div><?php }
}
