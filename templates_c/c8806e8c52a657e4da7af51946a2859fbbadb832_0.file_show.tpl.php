...
function content_68f8d4273a20d5_28010966 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
            <img src="<?php echo $_smarty_tpl->getValue('TPL_URL');?>
/images/mapping.png" alt="" class="section-image">
        </div>
    </div>
</section>
